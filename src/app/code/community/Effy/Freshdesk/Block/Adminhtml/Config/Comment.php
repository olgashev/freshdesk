...
/**
 * Class Effy_Freshdesk_Block_Adminhtml_Config_Comment
 */
class Effy_Freshdesk_Block_Adminhtml_Config_Comment extends Mage_Adminhtml_Block_System_Config_Form_Field
{
