...
/**
 * Class Effy_Freshdesk_Block_Customer_Ticket_View
 *
 * @method Effy_Freshdesk_Model_Ticket getTicket
 * @method array getNotes
 * @method Effy_Freshdesk_Model_User getUser
 * @method Effy_Freshdesk_Block_Customer_Ticket_View setTicket
 * @method Effy_Freshdesk_Block_Customer_Ticket_View setNotes
 * @method Effy_Freshdesk_Block_Customer_Ticket_View setUser
 */
class Effy_Freshdesk_Block_Customer_Ticket_View extends Effy_Freshdesk_Block_Customer_Ticket_Abstract
{
    ...
    public function __construct()
    {
        ...
        if (Mage::helper('freshdesk')->isTicketTabEnabled()) {
            ...
            if (!$user->getId()) {
                $user = Mage::getModel('effy_freshdesk/user')->load(Mage::helper('freshdesk')->getCurrentTicket()->getRequesterId());
            }
            $this->setUser($user);
        }
    }
    ...
    {
        return Mage::app()->useCache(Effy_Freshdesk_Model_Cache::CACHE_TYPE);
    }
