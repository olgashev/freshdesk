...
/**
 * Class Effy_Freshdesk_Model_Field_Nested_Field
 *
 * @method array getNestedTicketFields
 * @method array getNestedChoices
 */
class Effy_Freshdesk_Model_Field_Nested_Field extends Effy_Freshdesk_Model_Field
{
    /**
     * @return Varien_Object
     * @throws Effy_Freshdesk_Exception
     */
    public function getFirstLevelField()
    {
        if ($this->_getData('nested_ticket_fields_level_1') === null) {
            ...
            if (empty($fields[0])) {
                throw new Effy_Freshdesk_Exception('Error nested ticket fields');
            }
