...
/**
 * Class Effy_Freshdesk_Model_Freshdesk
 */
class Effy_Freshdesk_Model_Freshdesk
{
    const DEFAULT_PASSWORD = 'X';

    const URL_SUFFIX_DASHBOARD   = 'a';
    const URL_SUFFIX_SSO         = 'login/sso';
    const URL_SUFFIX_TICKET_EDIT = 'a/%d/edit';
    const URL_SUFFIX_TICKET_VIEW = 'a/tickets/%d';
    ...
    public function __construct()
    {
        if (!$domain = $this->getHelper()->getDomain()) {
            Mage::exception('Effy_Freshdesk', $this->getHelper()->__('Error Freshdesk domain'));
        }
