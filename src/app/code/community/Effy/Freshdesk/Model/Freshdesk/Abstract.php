...
/**
 * Class Effy_Freshdesk_Model_Freshdesk_Abstract
 *
 * @method string getRequestMethod
 */
class Effy_Freshdesk_Model_Freshdesk_Abstract
    extends Effy_Freshdesk_Model_Cache
    implements Effy_Freshdesk_Model_Freshdesk_Interface
{
    const XML_ROOT = 'root';
    ...
    protected function _construct()
    {
        ...
        $this->setFreshdesk(Mage::getSingleTon('effy_freshdesk/freshdesk'));
    ...
    /**
     * @param Effy_Freshdesk_Model_Freshdesk $freshdesk
     */
    ...
    {
        Mage::exception('Effy_Freshdesk', $message);
    }
