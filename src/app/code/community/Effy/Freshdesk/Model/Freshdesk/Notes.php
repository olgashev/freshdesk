...
/**
 * Class Effy_Freshdesk_Model_Freshdesk_Notes
 *
 */
class Effy_Freshdesk_Model_Freshdesk_Notes extends Effy_Freshdesk_Model_Freshdesk_Abstract
{
    ...
    public function saveNote($id = null)
    {
        if (!is_int($this->_ticketId)) {
            throw new Effy_Freshdesk_Exception('Wrong ticket id');
        }
